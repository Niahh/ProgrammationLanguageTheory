 ...
 * <li> {@link #oneOf(String[]) oneOf} can be used to group alternatives.
...
public class RE {
    ...
    */
     ...
     * - see {@link Pattern Pattern} for values for x.
     ...
     * @param on    Flags to turn on (see {@link Pattern Pattern}).
     * @param off   Flags to turn off (see {@link Pattern Pattern}).
